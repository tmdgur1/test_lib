import type { UnpackedMessageContext, WalletCreateKeyOptions } from './Wallet';
import type { WalletConfig, WalletConfigRekey, WalletExportImportConfig, EncryptedMessage } from '../types';
...
export declare class WalletApi {
    ...
    pack(payload: Record<string, unknown>, recipientKeys: string[], senderVerkey?: string | undefined): Promise<EncryptedMessage>;
